...
final class PreviewTableView: NSTableView {
...
// MARK: - PreviewMetadataRow

final class PreviewMetadataRow: NSView {
...
// MARK: - SelectionPreviewPane

final class SelectionPreviewPane: NSView {
...
final class QuickLookPreviewView: NSView, NSSplitViewDelegate {
    ...
    let emptyField = NSTextField(labelWithString: "")
    let tableDataSource = PreviewTableDataSource()
    let outlineDataSource = PreviewOutlineDataSource()
    ...
    var contentMode: PreviewContentMode = .table
    var folderRootCount = 0
    ...
    private func applyChrome(title: String, subtitle: String, icon: NSImage, badge: String?) {
    ...
    func showTable(rows: [PreviewRow], emptyMessage: String) {
        contentMode = .table
    ...
    func showOutline(emptyMessage: String) {
