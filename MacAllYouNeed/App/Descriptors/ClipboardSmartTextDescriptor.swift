...
enum ClipboardSmartTextDescriptor {
    static func descriptor() -> FeatureDescriptor {
        FeatureDescriptor(
            ...
            detailDescription: "Adds an on-device intelligence layer over the clipboard: inline math results, "
                + "tracking-parameter removal, email/URL/phone/JWT/color/code detection, background image OCR, "
                + "sensitive-content filtering, and slash/regex/semantic search.",
            requiredPermissions: [],
