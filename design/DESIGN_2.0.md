...
- Voice caption chip + hub pill, if they need shared material behavior
...
```text
┌─────────────────────────────┐
│ Starting microphone...      │  caption chip
└─────────────────────────────┘
          gap 5 px
      ┌──────────────┐
      │ ▂ ▄ ▆ █ ▆ ▄ │  hub pill
...
- caption always above hub pill
- caption radius: 10-12 px
- hub pill radius: capsule
- text: primary at 92% on glass
- waveform: monochrome
- panel: borderless, non-activating, clear background
- no purple mic branding
...
|---|---|---|
| Idle | hidden | hidden |
| Starting | `Starting microphone...` | pulsing dot |
| Listening | `Listening` or hidden | waveform active |
| Transcribing | `Transcribing...` | waveform dim + pulsing line |
| Inserted | `Inserted` | compress then fade |
| Failed | `Could not transcribe` | stable, action available |
...
- caption changes to `Transcribing...`
- pulsing line appears
- duration: 160 ms

Transcribing → done:

- caption changes to `Inserted`
- hub compresses slightly
